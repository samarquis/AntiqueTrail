...
reset role;
select is((select count(*) from app_private.role_grants where subject_user_id='35100000-0000-4000-8000-000000000001' and role='shopper' and state='active'),0::bigint,'Admin session registration does not create shopper admission');
