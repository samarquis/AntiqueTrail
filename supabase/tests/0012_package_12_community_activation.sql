...
insert into auth.users(id) values('12000000-0000-4000-8000-000000000090');
insert into release_private.regional_releases(
  ...
  '12000000-0000-4000-8000-000000000091','topeka-ks','sha256:'||repeat('1',64),
  'sha256:'||repeat('2',64),'sha256:'||repeat('3',64),'active',9,'12000000-0000-4000-8000-000000000092'
);
insert into release_private.release_evidence_receipts(
  ...
  '12000000-0000-4000-8000-000000000092','12000000-0000-4000-8000-000000000091','signed_release_receipt',
...
) values ('12000000-0000-4000-8000-000000000091',true,true,true,true,true);
insert into rg01_private.rg01_runs(
  ...
  '12000000-0000-4000-8000-000000000093','12000000-0000-4000-8000-000000000091',
...
insert into rg01_private.rg01_signing_challenges(
  ...
  '12000000-0000-4000-8000-000000000094','12000000-0000-4000-8000-000000000093',
  '12000000-0000-4000-8000-000000000090',decode(repeat('0a',32),'hex'),'pass',array[]::text[],
...
insert into rg01_private.rg01_receipts(
  ...
  '12000000-0000-4000-8000-000000000095','12000000-0000-4000-8000-000000000093',
  '12000000-0000-4000-8000-000000000094','12000000-0000-4000-8000-000000000091',
  '12000000-0000-4000-8000-000000000090','ProductOwner','pass',decode(repeat('0a',32),'hex'),
...
update rg01_private.rg01_runs set state='signed',receipt_id='12000000-0000-4000-8000-000000000095',disposed_at=statement_timestamp()
where run_id='12000000-0000-4000-8000-000000000093';
...
('12000000-0000-4000-8000-000000000002','rg01_pass','ProductOwner','pass','topeka',null,null,null,null,
 decode(repeat('02',32),'hex'),true,'{"all_predicates_pass":true}'::jsonb,'12000000-0000-4000-8000-000000000095'),
...
('12000000-0000-4000-8000-000000000004','activation','ProductOwner','pass','osage-city','12000000-0000-4000-8000-000000000101',null,
 ...
 '{"signed_frozen_artifacts":true,"recovery_capacity":true,"channel_consents":true,"canonical_route_bound":true,"canonical_route":"/stores?area=osage-city","schema_config_bound":true,"zero_blocking_defects":true}'::jsonb,null);
