...
- Current product and evidence gaps: #123 rejected-media resubmission, #124 Package 13 pgTAP contract, and #126 media-ticket evidence reconciliation. #174 (Free/Gallery/Full Gallery migration) is OPEN; PR #186 merged, but its independent production review found an unresolved active-billing vocabulary defect and the repair remains pending in live GitHub.
