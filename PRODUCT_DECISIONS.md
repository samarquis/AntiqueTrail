...
Status: historical decision record with links to current requirement owners. Original headings, approval wording, and deferred-choice history are preserved; this file does not independently redefine current product policy. Read PRD.md for current behavior and unresolved choices, and README.md for specialist ownership.
...
Current rules are owned by [PRD.md](PRD.md), its [capability reference](docs/specs/product-capabilities.md), [security applicability](SECURITY_AND_TRUST.md#store-first-stage-applicability), membership and Package13. [ADR0009](docs/adr/0009-store-first-stage-applicability.md) defines the limited sequencing supersession. Earlier decisions below retain historical reasons but do not override this stage change. No implementation, deployment, outreach, provider operation, public release or billing activation is authorized by this amendment.
...
Current requirement owner: [PWA first policy](docs/specs/product-capabilities.md#product-type). The record below preserves its original wording.
...
Current requirement owner: [Public ratings resemble Google-style ratings policy](docs/specs/product-capabilities.md#rating-model). The record below preserves its original wording.

Stores have public 1–5 star aggregate ratings and review counts.

### Separate rating concepts

Current requirement owner: [Separate rating concepts policy](docs/specs/product-capabilities.md#rating-model). The record below preserves its original wording.
...
Current requirement owner: [Directory data sources and provenance policy](docs/specs/product-capabilities.md#public-store-directory). The record below preserves its original wording.
...
Current requirement owner: [Official Store Profile Photos policy](docs/specs/product-capabilities.md#official-store-profile-photos). The record below preserves its original wording.
...
Current requirement owner: [Selected visual direction](DESIGN_SYSTEM.md#selected-visual-direction). The record below preserves its original wording.
...
Current requirement owner: [Listing freshness and stale behavior policy](docs/specs/product-capabilities.md#listing-freshness). The record below preserves its original wording.
...
Current requirement owner: [Trip app owns the itinerary policy](docs/specs/product-capabilities.md#todays-trip-requirements). The record below preserves its original wording.
...
Current requirement owner: [Recipient-specific Candidate Share policy](docs/specs/product-capabilities.md#candidate-link-capture-and-trip-ideas). The record below preserves its original wording.
...
Current requirement owner: [Candidate Share expiry and cleanup policy](docs/specs/product-capabilities.md#candidate-link-capture-and-trip-ideas). The record below preserves its original wording.
...
Current requirement owner: [Candidate Share delivery and abuse protection policy](docs/specs/product-capabilities.md#candidate-link-capture-and-trip-ideas). The record below preserves its original wording.
...
Current requirement owner: [Store Representative publishing split policy](docs/specs/product-capabilities.md#business-accounts). The record below preserves its original wording.
...
Current requirement owner: [Administrator approval during Internal Alpha and Private Beta policy](docs/specs/product-capabilities.md#business-accounts). The record below preserves its original wording.
...
Current requirement owner: [Trip construction and readiness policy](docs/specs/product-capabilities.md#todays-trip-requirements). The record below preserves its original wording.
...
Current requirement owner: [Administrator home and review workspace policy](docs/specs/product-capabilities.md#administrator-workspace). The record below preserves its original wording.
...
Current requirement owner: [Photo moderation criteria](docs/specs/store-membership-spec.md#photo-moderation-criteria). The record below preserves its original wording.
...
## 2026-09-12 — Free public test publishing and account entry

The owner approved the presented `update plan` scope with `yes make this happen. I want the link after you use computer use and test it in a unsigned in`, then delegated implementation choices. Prioritize a stable free public fictional test, ordinary application account entry for the authorized testers, preserved existing beta data and computer-use proof while signed out. Current scope is owned by [PRD public test](PRD.md#public-test-publication), [ADR0010](docs/adr/0010-free-public-test-publication.md), [security](SECURITY_AND_TRUST.md#public-test-boundary) and [execution](PACKAGE_CONTRACTS.md#public-test-execution-contract). #369 owns the dedicated amendment; actual publication and account readiness require their own evidence.
