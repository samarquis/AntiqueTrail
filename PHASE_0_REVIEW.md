...
- ADR 0005 selects Cloudflare Pages Free for the static shared-startup PWA and Supabase Free for the remote startup backend. Deny-by-default Cloudflare Access covers every shared hostname; preview-only Access is insufficient. `$0`/no-overage/capacity/restore gates apply. Regional Public remains blocked until 15-minute RPO is paid-approved or otherwise proven.
