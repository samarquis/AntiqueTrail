...
- No store-owner outreach, real-store import, or external participant is allowed until both Internal Alpha stages pass and a separate External Testing Readiness gate is defined and passed. Whether a store owner first joins controlled Private Beta or waits until public access remains unresolved. Approved 2026-07-27.
