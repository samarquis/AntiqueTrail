# Gates: Decision → Plan → Ticket-tree turn

Scope: owner rulings (tickets-only, dark mode in W1, staged-off billing) recorded; TDD development plan doc written; 16-ticket tree (#105–#120) cut and verified open; plan numbering matches actual issue numbers; committed and pushed. NO code authorized — start instruction still pending.
