...
- An isolated Supabase project completed `db reset --local` through migration `20260903040000`. Focused pgTAP 0078 passed 46/46 after that reset, including invitation-independent public consent, signal retry binding, runtime start/retry/signals/verification/approval, exact Free-tier authority, runtime portable receipt export, and applicant/Administrator purge plus provider-user deletion.
