...
- Use realistic, clearly labeled fictional stores and permitted synthetic imagery with recorded provenance, enough variety to exercise photos, favorites, hours, and trip planning. Existing synthetic-content restrictions still apply; no real names, logos, photos, reviews, or implied affiliation. Dataset size and actual setup must fit the separately authorized [fixture-only 50-photo evaluation profile](DESIGN.md#fixture-only-50-photo-evaluation-profile): each designated Synthetic Store carries approximately 50 distinct, locally hosted, generated fictional photo records with meaningful alternative text, and the profile is never presented as a public Free/Gallery/Full Gallery tier.
